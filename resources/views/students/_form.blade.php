<div class="grid gap-6 md:grid-cols-2">
    ...
    <div>
        <label for="classroom_id" class="label">{{ __('students.form_classroom') }}</label>
        <select id="classroom_id" name="classroom_id" required class="field">
            <option value="">{{ __('students.form_select') }}</option>
    ...
    <div>
        <label for="school_year_id" class="label">{{ __('students.form_school_year') }}</label>
    ...
    <div class="md:col-span-2 border-t border-slate-200 pt-4">
        <label class="flex items-center gap-2 text-sm">
            ...
            {{ __('students.form_create_parent') }}
        </label>
    </div>

    <div class="md:col-span-2" data-existing-parent>
        <label for="parent_id" class="label">{{ __('students.form_existing_parent') }}</label>
    ...
    <div class="md:col-span-2 hidden grid gap-4 md:grid-cols-2" data-new-parent>
        <div>
            <label for="parent_name" class="label">{{ __('students.form_parent_name') }}</label>
            <input id="parent_name" name="parent_name" class="field" value="{{ old('parent_name') }}">
        </div>
        <div>
            <label for="parent_email" class="label">{{ __('students.form_parent_email') }}</label>
            <input id="parent_email" name="parent_email" type="email" class="field" value="{{ old('parent_email') }}">
        </div>
        <div>
            <label for="parent_phone" class="label">{{ __('students.form_parent_phone') }}</label>
            <input id="parent_phone" name="parent_phone" class="field" value="{{ old('parent_phone') }}">
        </div>
        <div>
            <label for="parent_password" class="label">{{ __('students.form_parent_password') }}</label>
