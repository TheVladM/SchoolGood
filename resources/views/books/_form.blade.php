<div class="grid gap-6 md:grid-cols-2">
    ...
    <div>
        <label for="shelf_location" class="label">{{ __('books.form_shelf_location') }}</label>
        <input id="shelf_location" name="shelf_location" type="text" value="{{ old('shelf_location', $book->shelf_location ?? '') }}" class="field">
    </div>

    <div>
        <label for="loan_duration_days" class="label">{{ __('books.form_loan_duration') }}</label>
    ...
    <div>
        <label for="late_fee_per_day" class="label">{{ __('books.form_late_fee') }}</label>
    ...
    <div>
        <label for="acquired_at" class="label">{{ __('books.form_acquired_at') }}</label>
    ...
    <div class="md:col-span-2">
        <label for="description" class="label">{{ __('books.form_description') }}</label>
