        ...
        @auth
            @php
                $navItems = [
                    ...
                    ['route' => 'students.*', 'url' => route('students.index'), 'label' => 'Eleves', 'icon' => 'users'],
                ...
                if (auth()->user()->hasAnyRole([\App\Enums\UserRole::Founder, \App\Enums\UserRole::Admin, \App\Enums\UserRole::Scolarite])) {
                    $navItems[] = ['route' => 'school-years.*', 'url' => route('school-years.index'), 'label' => 'Annees scolaires', 'icon' => 'academic'];
                    $navItems[] = ['route' => 'books.*', 'url' => route('books.index'), 'label' => 'Bibliotheque', 'icon' => 'library'];
                ...
                <aside class="app-sidebar" aria-label="Navigation">
                    <div class="app-sidebar__inner">
                        ...
                        <a href="{{ route('dashboard') }}" class="sidebar-brand">
                            <span class="sidebar-brand__mark">SG</span>
                            <span class="sidebar-brand__text">
                                <span class="sidebar-brand__title">SchoolGood</span>
                                <span class="sidebar-brand__tag">Etablissement</span>
                            </span>
                        </a>
