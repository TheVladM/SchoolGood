<div class="grid gap-6 md:grid-cols-2">
    <div class="md:col-span-2">
        <label for="book_id" class="label">{{ __('book_loans.form_book') }}</label>
        <select id="book_id" name="book_id" required class="field">
            <option value="">{{ __('book_loans.form_select') }}</option>
    ...
    <div>
        <label for="student_id" class="label">{{ __('book_loans.form_student') }}</label>
        <select id="student_id" name="student_id" class="field">
            <option value="">{{ __('book_loans.form_none') }}</option>
    ...
    <div>
        <label for="user_id" class="label">{{ __('book_loans.form_teacher') }}</label>
    ...
    <div>
        <label for="borrowed_at" class="label">{{ __('book_loans.form_borrowed_at') }}</label>
    ...
    <div>
        <label for="due_at" class="label">{{ __('book_loans.form_due_at') }}</label>
        <input id="due_at" name="due_at" type="date" value="{{ old('due_at', isset($loan) ? $loan->due_at?->format('Y-m-d') : '') }}" class="field">
    </div>

    <div>
        <label for="daily_penalty_rate" class="label">{{ __('book_loans.form_penalty_rate') }}</label>
    ...
    <div class="md:col-span-2">
        <label for="notes" class="label">{{ __('book_loans.form_notes') }}</label>
